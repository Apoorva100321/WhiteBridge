...
import { FaArrowRight, FaChevronRight, FaStarHalfAlt } from "react-icons/fa";
...
const WorldPremium = dynamic(
  () => import("@/components/globe-premium").then((mod) => mod.WorldPremium),
  {
    ssr: false,
    loading: () => (
...
export default function HeroPremium() {
  ...
  return (
    <section
      ...
      className="relative min-h-screen flex items-start overflow-x-hidden"
    >
      ...
      <div className="relative z-10 w-full">
        <div className="max-w-[1500px] mx-auto px-5 sm:px-6 md:px-8 lg:px-10 xl:px-12">
          <div className="flex flex-col lg:flex-row items-start justify-center min-h-screen pt-4 pb-8 lg:pt-6 lg:pb-12 gap-8 lg:gap-6">
            {/* Left Content - Premium Design */}
            <div className="w-full lg:w-[48%] xl:w-[45%] text-center lg:text-left z-20 flex flex-col justify-start pt-16 lg:pt-20">
            ...
            {/* Right Side - Globe */}
            <div className="w-full lg:w-[52%] xl:w-[55%] relative pt-0 -mt-4 lg:-mt-6">
